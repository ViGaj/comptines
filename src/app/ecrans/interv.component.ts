...
//		this.m_classe_boutons=new Array(4);
		...
		cols=new Array(5);
		cols[0]=new ColonneEcran("etat","etat",TypeColEcran.Chaine,false,ModifCol.NonModifiable,false,true,100);
		cols[1]=new ColonneEcran("id_seance_cmpt","id_seance_cmpt",TypeColEcran.ClePrimaire,false,ModifCol.NonModifiable,false,false,100);
		cols[2]=new ColonneEcran("id_seance","id_seance",TypeColEcran.Entier,false,ModifCol.NonModifiable,false,false,100);
		...
		cols[2]=new ColonneEcran("id_interv","id_interv",TypeColEcran.Entier,false,ModifCol.NonModifiable,false,false,100);
		cols[3]=new ColonneEcran("id_intervWITH","Intervention Date/Lieu",TypeColEcran.Chaine,false,ModifCol.NonModifiable,true,true,100);
		...
		this.formOngletPrincipal=this.formBuilder.group({m_date_interv:'', m_id_seance:0,m_id_lieu:0,m_comm_interv:'',m_tarif_interv:0,m_fact_interv:0,m_num_interv:''});
